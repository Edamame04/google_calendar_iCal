...
public class iCalGenerator {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = iCalGenerator.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
        if (in == null) {
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        System.out.println("User's calendars:");
        ...
        // List the next 30 events from each calendar
        for (CalendarListEntry calendar : calendars) {
            System.out.println("\nEvents for calendar: " + calendar.getSummary());
